...
const RestaurantCard = (props) => {
    ...
    return (
        <div data-testid="resCard" className="m-4 p-4 w-[280px] rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl" style={{ backgroundColor: "#ffffff" }}>
