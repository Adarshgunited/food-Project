    ...
    return (
        ...
        {items.map((item) => (
          <div
            ...
            className="p-4 border-b border-gray-300 flex flex-col md:flex-row justify-between items-center animate-fadeIn transition duration-300 ease-in-out transform hover:scale-105 bg-white shadow-lg rounded-lg"
          >
