...
const Body = () => {
  ...
  return listOfRestaurant.length === 0 ? (
    ...
    >
      <div
        className="flex flex-wrap justify-between items-center shadow-lg 
            p-4 
            lg:ml-36
            lg:mr-36 
            "
      >
        ...
        >
          ...
          />
          <button
            className="py-2 px-4 ml-2 bg-green-400 rounded-lg transition duration-300 hover:bg-green-600 font-bold"
            //
